...
@Directive({
  selector: '[ms-navbar-dropdown], [navbarDropdown], [navbar-dropdown]'
})
...
@Directive({
  selector: '[ms-navbar-link], [navbarLink], [navbar-link]'
})
...
@Directive({
  selector: '[ms-navbar-item], [navbarItem], [navbar-item]'
})
...
@Component({
  selector: 'ms-navbar',
  template: `<ng-content select="ms-navbar-menu"></ng-content>`,
...
@Component({
  selector: 'ms-navbar-menu',
  template: `<ng-content select="ms-navbar-menu-group"></ng-content>`,
  encapsulation: ViewEncapsulation.None
})
