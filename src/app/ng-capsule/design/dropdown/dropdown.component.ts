...
*/
@Directive({
  selector: 'ms-dropdown-item, [ms-dropdown-item], [dropdown-item]'
})
...
@Component({
  selector: 'ms-dropdown-menu',
  template: `
    <div class="dropdown-content">
      <ng-content select="ms-dropdown-item, [ms-dropdown-item], [dropdown-item]"></ng-content>
    </div>`,
  encapsulation: ViewEncapsulation.None,
})
...
@Component({
  ...
  template: `
    <ng-content select="ms-dropdown-trigger"></ng-content>
    <ng-content select="ms-dropdown-menu"></ng-content>
  `,
